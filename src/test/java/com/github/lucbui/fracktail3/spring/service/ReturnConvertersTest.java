...
class ReturnConvertersTest {
    ...
    void shouldReturnVoidsWhenVoidType() {
        ReturnComponent.ReturnConverterFunction<? super BaseContext<?>> rcf = returnConverters.getHandlerForType(Void.class)
    ...
    void shouldReturnVoidsWhenVoidPrimitiveType() {
        ReturnComponent.ReturnConverterFunction<? super BaseContext<?>> rcf = returnConverters.getHandlerForType(Void.TYPE)
                .orElseGet(Assertions::fail);
    ...
    void shouldReturnMonosWhenMonoType() {
        ReturnComponent.ReturnConverterFunction<? super BaseContext<?>> rcf = returnConverters.getHandlerForType(Mono.class)
                .orElseGet(Assertions::fail);
    ...
    void shouldReturnFluxsWhenFluxType() {
        ReturnComponent.ReturnConverterFunction<? super BaseContext<?>> rcf = returnConverters.getHandlerForType(Flux.class)
                .orElseGet(Assertions::fail);
    ...
    void shouldReturnStringsWhenStringType() {
        ReturnComponent.ReturnConverterFunction<? super BaseContext<?>> rcf = returnConverters.getHandlerForType(String.class)
                .orElseGet(Assertions::fail);
    ...
    void shouldReturnFStringsWhenFormattedStringType() {
        ReturnComponent.ReturnConverterFunction<? super BaseContext<?>> rcf = returnConverters.getHandlerForType(FormattedString.class)
                .orElseGet(Assertions::fail);
    ...
    void shouldReturnBotResponsesWhenBotResponseType() {
        ReturnComponent.ReturnConverterFunction<? super BaseContext<?>> rcf = returnConverters.getHandlerForType(BotResponse.class)
                .orElseGet(Assertions::fail);
