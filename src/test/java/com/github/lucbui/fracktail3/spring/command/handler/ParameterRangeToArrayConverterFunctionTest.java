...
class ParameterRangeToArrayConverterFunctionTest extends BaseFracktailTest {
    @Mock
    ...
    void arrayIdentityShouldReturnCorrectly() {
        ...
        ParameterRangeToArrayConverterFunction handler = new ParameterRangeToArrayConverterFunction(0, 2, String.class, converters);
    ...
    void arrayIdentityShouldConvertAndReturnCorrectly() {
        ...
        ParameterRangeToArrayConverterFunction handler = new ParameterRangeToArrayConverterFunction(0, 2, Integer.TYPE, converters);
