...
public class InjectPlatformHandler implements ParameterBaseComponent.ParameterConverterFunction<ScheduledUseContext> {
    ...
    @Override
    public Object apply(ScheduledUseContext context) {
        if(id == null) {
