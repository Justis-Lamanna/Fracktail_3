...
import com.github.milomarten.fracktail3.spring.command.annotation.Name;
import com.github.milomarten.fracktail3.spring.command.annotation.Usage;
import com.github.milomarten.fracktail3.spring.command.factory.ReflectiveCommandActionFactory;
...
public class CommandConfigurer extends FieldAndMethodBasedConfigurer {
    ...
    public void configure(Object bean, String beanName) {
        if(bean instanceof com.github.milomarten.fracktail3.magic.command.Command) {
            LOGGER.debug("Adding Command Bean of id {}", beanName);
            com.github.milomarten.fracktail3.magic.command.Command c = (com.github.milomarten.fracktail3.magic.command.Command)bean;
            addOrMerge(c);
        } else if(bean instanceof CommandAction) {
            LOGGER.debug("Adding CommandAction Bean of id {}", beanName);
            com.github.milomarten.fracktail3.magic.command.Command.Builder c = new com.github.milomarten.fracktail3.magic.command.Command.Builder(beanName)
    ...
    private void handleAnnotations(AnnotatedElement element, com.github.milomarten.fracktail3.magic.command.Command.Builder c) {
    ...
    private void addOrMerge(com.github.milomarten.fracktail3.magic.command.Command c) {
        Optional<com.github.milomarten.fracktail3.magic.command.Command> old = commandList.getCommandById(c.getId());
        if(old.isPresent()) {
